  ...
  return (
    <div className='side2' data-aos="fade-down-right">
        ...
        {/* <div class="timeline">
            <div class="timeline-item">
                <div class="timeline-item-content">
                    <span class="tag" style={{background: '#f45b69'}} >2007 - 2010</span>
                    <h3>Education Quality</h3>
                    <p class="title">Personal Portfolio April Fools</p>
                    <p class="institution">University of DVI (1997 - 2001)</p>
                    <span class="rating">4.30/5</span>
                    <p class="description">
                        The education should be very interactural. Ut tincidunt est ac dolor aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem in, lobortis mauris hendrerit ante.
                    </p>
